...
The error dump file generated by `not-so-human-panic` contains the following fields.
...
[1]: https://img.shields.io/crates/v/not-so-human-panic.svg?style=flat-square
[2]: https://crates.io/crates/not-so-human-panic
[3]: https://img.shields.io/travis/rust-cli/not-so-human-panic.svg?style=flat-square
[4]: https://travis-ci.org/rust-cli/not-so-human-panic
[5]: https://img.shields.io/crates/d/not-so-human-panic.svg?style=flat-square
[6]: https://crates.io/crates/not-so-human-panic
[7]: https://docs.rs/not-so-human-panic/badge.svg
[8]: https://docs.rs/not-so-human-panic
